...
#define C_LIMIT 4095	/* Color limit */
...
public:
	...
	// Helper functions to sort and swap vertices
	inline void sort(GzCoord* v, GzCoord* norms, GzTextureIndex* textures);				/* sorts coordinates by ascendiny y-values */
	inline void swap(GzCoord v1, GzCoord v2);	/* swaps two coordinates */
	inline void swap(GzTextureIndex* first, GzTextureIndex* second);					/* To sort GzTextureIndices */
	inline float dtor(float degree);			/* converts the float to radians */
	inline void resetMatrix(GzMatrix);			/* Sets matrix elements to 0.0f */

	// HW4 Additional function
